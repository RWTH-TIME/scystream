"""add block_dependencies to imported models

Revision ID: 449a1635be99
Revises: 09c39621eadc
Create Date: 2025-01-07 22:01:35.030754
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['downstream_block_uuid'], ['blocks.uuid'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['upstream_block_uuid'], ['blocks.uuid'], ondelete='CASCADE'),
    ...
    sa.ForeignKeyConstraint(['entrypoint_uuid'], ['entrypoints.uuid'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('uuid')
    )
    ...
    op.create_foreign_key(None, 'blocks', 'entrypoints', ['selected_entrypoint_uuid'], ['uuid'], ondelete='SET NULL')
